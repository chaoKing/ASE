 ...
 * 文件创建时间：2014-8-9
 */
package scau.chao.ase.magnifyshrinkimage;
 ...
 * 
 */
public class MagnifyShrinkImageActivity extends Activity {
  /* 相关变量声明 */
  ...
  public void onCreate(Bundle savedInstanceState) {
    ...
    /* 加载main.xml Layout */
    setContentView(R.layout.activity_magnify_shrink_image);
    ...
    /* 初始化相关变量 */
    bmp = BitmapFactory.decodeResource(getResources(), R.drawable.welcome_to_chao);
